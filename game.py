...
def remove_spaces(text):
    ...
    """
    # t2=""
    # for f in range(0,len(text),1):
    #     if text[f].isalpha() or text[f]==" ":
    #         t2=t2+text[f]
    # #one that works
    # counter=0
    # for c in text3:
...
def exit_leads_to(exits, direction):
    ...
    #direction=reception=room_reception
...
def print_menu(exits):
    ...
    """
    # for key in current_room["exits"].keys():
    #     print('Direction', key, ' leads to ', format(current_room["exits"][key]))
